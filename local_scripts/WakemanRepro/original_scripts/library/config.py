...
if user == 'gramfort':
    ...
    # Original default pointed 3 levels up from this file (a stray location
    # outside this project). Redirected to our derivatives folder — folder
    # name only, no logic change (see original_scripts/GLITCHES.md).
    study_path = os.path.join(
        os.path.dirname(__file__), '..', '..', 'derivatives', 'biomag_repro')
    N_JOBS = 1
