...
def run_covariance(subject_id, tsss=False):
    ...
    # shuffle=True: current sklearn raises ValueError for a random_state
    # without it (KFold's default shuffle=False makes random_state a no-op,
    # which sklearn now treats as a usage error). See GLITCHES.md.
